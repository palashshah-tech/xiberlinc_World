...
export function WelcomeView(params = {}) {
          ...
          <form id="reg-form" class="wv-form">
            ...
            <div class="input-grid">
              <div class="field" style="grid-column: 1 / -1;">
                <label>${t('label_access_code')}</label>
                <input type="text" id="r-access" placeholder="${t('access_placeholder')}" required />
  ...
  document.getElementById('reg-form').addEventListener('submit', async (e) => {
    ...
    if (!accessCode) errors.push({ id: 'r-access', msg: t('access_required') });
    ...
    if (!codeInfo.ok) {
      if (codeInfo.reason === 'limit_reached') {
